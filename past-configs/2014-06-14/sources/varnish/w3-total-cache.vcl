# Plugin: https://wordpress.org/plugins/w3-total-cache/
# Location: W3 Total Cache (plugin files) > ini > varnish-sample-config.vcl
# Source: https://plugins.trac.wordpress.org/browser/w3-total-cache/trunk/ini/varnish-sample-config.vcl
